...
public class ExampleTests {
  ...
  public void testFullGame() {
    ...
    this.model.place(this.model.getCellAt(0, 1));
    this.model.place(this.model.getCellAt(3, 0));
    this.model.place(this.model.getCellAt(4, 1));
    this.model.pass();
    this.model.place(this.model.getCellAt(1, 0));
    this.model.place(this.model.getCellAt(3, 3));
    this.model.pass();
    this.model.place(this.model.getCellAt(1, 3));
    this.model.pass();
    this.model.pass();
